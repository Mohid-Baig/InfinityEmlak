...
const Collapsaible2 = () => {
  ...
  const rotateAnim = useRef(new Animated.Value(0)).current; // Animated value
    ...
    <View>
      <TouchableOpacity onPress={toggleExpanded}>
        <View style={styles.collapsaible}>
          ...
          <Text style={{color: '#fff', fontWeight: '800', marginLeft: 5}}>
            Over Due Payments
          </Text>
          ...
          <Animated.View
            style={{
              marginLeft: 120,
              transform: [{rotate}], // Apply rotation animation
            }}>
